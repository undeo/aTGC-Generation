...
void interference(int channel)
{
	...
	w.factory("Exponential:SM_Pdf(MWW,a1[-0.01,0.])");
	w.factory("Exponential:Pdf_cwww(MWW,a2[-0.01,0.])");
	w.factory("Exponential:Pdf_ccw(MWW,a3[-0.01,0.])");
	w.factory("Exponential:Pdf_cb(MWW,a4[-0.01,0.])");
	w.factory("Exponential:Int_cwww_ccw(MWW,a5[-0.01,0.])");
	w.factory("Exponential:Int_cwww_cb(MWW,a6[-0.01,0.])");
	w.factory("Exponential:Int_ccw_cb(MWW,a7[-0.01,0.])");
